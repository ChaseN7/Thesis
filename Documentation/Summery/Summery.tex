...
Den größten Teil der Zeit seit dem letzten Seminar habe ich mit programmieren Verbracht. Daher wird ein größerer Teil am Ende dem Ergebnis dieser Arbeit gewidmet.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{./TestResult}
		\caption[Test Resultat einer Test Datei]{Ergebnise einiger Tests}
		\label{Test Result}
	\end{figure}
...
\subsection{große Verbesserungen}
	\begin{itemize}
		...
		\item Fehler beim Laden nicht definierter Instanzen prüfen!
