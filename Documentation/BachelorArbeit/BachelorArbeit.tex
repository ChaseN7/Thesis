...
Ziel wird es sein zwei spezielle BPDL-Grenzwert-Prozesse simulieren zu k"onnen.
	...
	\begin{tabular}{ r p{18em} }
		...
		$ d(x) + \sum_{y=1}^{n} c(x,y) \cdot n_t(x) $ & Wie oben, nur mit $ n \hat{=} $ \#Merkmale, und $ n_t(x) \hat{=}$ \#Individuen zur Zeit t mit Merkmal $ x $
	\end{tabular}\\
	...
	\end{align*}
	mit $ \phi: M_F \to \mathbb{R} $ und $ n(x_i) \hat{=} $ \#Individuen mit Merkmal $ x_i $.\\	
