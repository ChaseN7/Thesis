...
\begin{frame}
	...
	\begin{minipage}{0.49\textwidth}
		\begin{figure}
		\centering	
		\includegraphics[width=0.8\linewidth]<4>{./Lizenzbilder/Okosystem1}%
		\visible<4>{\caption{\tiny\textregistered Kai Niemeyer  / pixelio.de}}
		\includegraphics[width=1\linewidth]<1,2,3>{./Lizenzbilder/Zelle1}%
		\visible<1,2,3>{\caption{\tiny\textregistered Harald Häck  / pixelio.de}}
		\end{figure}
	\end{minipage}	
	\begin{minipage}{0.49\textwidth}
		\begin{itemize}
...
%		\centering
		...
		\visible<2>{\caption{\tiny\textregistered Joachim Reisig  / pixelio.de}}
...
\section{Modell}
\begin{frame}{Was beschreibt also das Modell?}
	\begin{itemize}	
...
\begin{minipage}{0.49\textwidth}
		\begin{figure}
		\centering		
		\includegraphics[width=1\linewidth]<2->{./Lizenzbilder/Normalisierung1}%
		\end{figure}
		\includegraphics[width=1\linewidth]<2->{./Lizenzbilder/Normalisierung3}%
	\end{minipage}
	\begin{minipage}{0.49\textwidth}
		...
		\end{itemize}
		\visible<2->{{\tiny \textregistered kaibara87 \\ flickr.com/photos/kaibara/3839720754/\\
